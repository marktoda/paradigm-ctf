...
contract LearningCar is Car {
    constructor(Monaco _monaco) Car(_monaco) {}

    int256 constant ACCEL_SPEED_WEIGHT = 1;
    int256 constant ACCEL_PROGRESSION_WEIGHT = 1957;
    int256 constant ACCEL_PLACE_WEIGHT = -836;
    int256 constant ACCEL_OUR_COINS_WEIGHT = 3221;
    int256 constant ACCEL_NEXT_CAR_COINS_WEIGHT = -2897;
    int256 constant SHELL_FIRST_PROGRESSION_WEIGHT = -1817;
    int256 constant SHELL_FIRST_SPEED_WEIGHT = 9;
    int256 constant SHELL_PROGRESSION_WEIGHT = 1;
    int256 constant SHELL_FRONT_SPEED_WEIGHT = 1828;
    int256 constant SHELL_Y_DIFF_WEIGHT = 3395;
    int256 constant SHELL_OUR_COINS_WEIGHT = -3424;
    int256 constant SHELL_NEXT_CAR_COINS_WEIGHT = 0;
    int256 constant ACCEL_COST_WEIGHT = -2569;
    int256 constant SHELL_COST_WEIGHT = -2789;
