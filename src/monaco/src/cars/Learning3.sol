...
contract LearningCar3 is Car {
    constructor(Monaco _monaco) Car(_monaco) {}

    int256 constant ACCEL_SPEED_WEIGHT = -2;
    int256 constant ACCEL_PROGRESSION_WEIGHT = 1751;
    int256 constant ACCEL_PLACE_WEIGHT = 4573;
    int256 constant ACCEL_OUR_COINS_WEIGHT = 5455;
    int256 constant ACCEL_NEXT_CAR_COINS_WEIGHT = -1245;
    int256 constant SHELL_FIRST_PROGRESSION_WEIGHT = 0;
    int256 constant SHELL_FIRST_SPEED_WEIGHT = 1705;
    int256 constant SHELL_PROGRESSION_WEIGHT = 3943;
    int256 constant SHELL_FRONT_SPEED_WEIGHT = 2947;
    int256 constant SHELL_Y_DIFF_WEIGHT = 71724;
    int256 constant SHELL_OUR_COINS_WEIGHT = 1391;
    int256 constant SHELL_NEXT_CAR_COINS_WEIGHT = 4662;
